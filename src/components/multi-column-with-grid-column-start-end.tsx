...
/* component */
function MultiColumnGridStartEnd(): JSX.Element {
  const IMG_ROOT = import.meta.env.VITE_IMG_SRC;
  const brandsData = getJBIcons().splice(0, 9);
  return (
    <>
      <div className="container multiColumnGridStartEnd">
        ...
        <p className="info text-center">
          ...
          The third list item alone has been given <b>grid-column-start: 3</b> and <b>grid-column-end: 5</b>.
        </p>
      </div>
    </>
  );
...
/* exports */
export default MultiColumnGridStartEnd;
